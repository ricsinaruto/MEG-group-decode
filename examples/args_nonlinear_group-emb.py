...
class Args:
    ...
    func = {'train': True,
            'PFIch': True,
            'PFIts': True}  # dict of functions to run from training.py
    ...
    def __init__(self):
        ...
        self.kernelPFI = False  # whether to run PFI with kernel output metric
        self.pfich_timesteps = [[0, 256]]  # time window for spatiotemporal PFI
        self.PFI_perms = 10  # number of PFI permutations
        self.halfwin = 13  # half window size for temporal PFI
